...
author: Josh Bottum
title: Using Local LLM Models and LangChain to Evaluate Reasoning Ability of LLMs
subtitle: Testing LLMs with LangChain in a local environment for (6) types of reasoning
description: Within (30) minutes of reading this post, you should be able to complete model serving requests from two variants of a popular python-based large language model (LLM) using LangChain on your local computer
keywords: llms, large language models, langchain, models, prompts, testing, reasoning
meta_og_image: pct_eval_reasoning_llms_langchain_og_meta_card.png
---
...
![](./images/eval_reasoning_july_2023_image1.png "image_tooltip")
...
![](./images/eval_reasoning_july_2023_Figure_1.png "image_tooltip")
![](./images/eval_reasoning_july_2023_Figure_2.png "image_tooltip")
...
![](./images/eval_reasoning_july_2023_correct.png "image_tooltip")
...
* Cube + Patterson Consulting [Webinar](https://event.on24.com/wcc/r/4277494/E4B6E2FE4CF11C5DA82477349983E002)
* eBook: [An Introduction to LLMs](http://www.pattersonconsultingtn.com/content/intro_to_llms_ebook.html)
* Sign up for our [Free Private 90-min Workshop on LLMs](http://www.pattersonconsultingtn.com/campaigns/llm_workshop_july_2023.html)
* Check out our [Open Source LangChain Examples](https://github.com/pattersonconsulting/langchain_examples)
